...
template <class Y>
void stream_read_task(Y * p, Y * e)
{
    while (p != e)
    {
       __m128i i = _mm_stream_load_si128((__m128i *)p++);
    }
}
...
template <class Y>
void read_write(Y * p, Y * e, int value)
{
 
     
    __m128i i = _mm_set_epi32(value, value, value, value);
    volatile __m128i r_val;

    while (p != e)
    {
        _mm_store_si128((__m128i *)p++, i);
	r_val = (volatile __m128i) _mm_load_si128((__m128i *)p);
	r_val =  (volatile __m128i) _mm_load_si128((__m128i *)p);
...
//Initialize once the elements
int k = rand();
write_intensive_task(vector, vector + nelements, k );
    ...
    while (1)
    {
        ...
        case 0:
            ...
            break;
        case 2:
            cout << "Reading and Writing  memory\n";
            break;
        case 4:
            cout << "NT  Writing  memory\n";
            break;
        case 3:
            cout << "NT Reading  memory\n";
            break;
        default:
        ...
        while (i--)
        {
            ...
            case 0:
                ...
                break;
            case 2:
                read_write(vector, vector + nelements, r);
                break;
            case 4:
                stream_write_task(vector, vector + nelements, r);
		break;
            case 3:
                stream_read_task(vector, vector + nelements);
		break;
            default:
                stream_write_task(vector, vector + nelements, r);
            }
